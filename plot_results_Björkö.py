...
plt.plot(boat, array(peak_cost_bj)/1000 , color='olivedrab', marker='.')
plt.plot(boat, array(nord_pool_cost_bj)/1000, marker='.', color='teal')
plt.plot(boat, array(LFM_cost_01_bj)/1000, marker='.', color='indianred')
...
plt.plot(boat, array(nord_pool_revenue_bj)/1000, marker='.', color='teal')
plt.plot(boat, array(LFM_total_revenue_01_bj)/1000, marker='.', color='indianred')
plt.plot(boat, array(FCR_D_up_revenue_01_bj)/1000, color='lightsteelblue', marker='.')
plt.plot(boat, array(FCR_D_down_revenue_01_bj)/1000, color='cornflowerblue', marker='.')
plt.plot(boat, array(total_revenue_bj)/1000, color='black', marker='.')
...
ax2 = ax1.twinx()
#ax2.plot(boat, array(peak_cost_bj)/1000, color='olivedrab', marker='.', linestyle='--', label='Optimized Grid Usage Cost')
#ax2.plot(boat, array(optimized_cost_nordpool_bj)/1000, color='teal', marker='.', linestyle='--', label='Final Cost')
#ax2.plot(boat, array(optimized_cost_LFM_01_bj)/1000, color='indianred', marker='.', linestyle='--', label='Final Cost')
ax2.plot(boat, array(optimized_cost_FCR_D_LFM_01_bj)/1000, color='black', marker='.', linestyle='--', label='Final Cost')
