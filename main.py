...
#________Reference Case____________________________________________________________________________________________________
#Calculating the sum of the array for the yearly load 1X365 at Besskroken
yearly_load_bessekroken=np.zeros((365))
for i in range(365):
    yearly_load_bessekroken[i] = sum(load_bessekroken[:, i])

#_________Plotting_________________________________________________________________________________________________________
#Plotting the daily load at Bessekroken
...
plt.title('Electricity Load in 2023')
#plt.legend()
...
#_________Case 1_______________________________________________________________________________________________________________
