...
plt.plot(boat, array(peak_cost_be)/1000 , color='olivedrab', marker='.')
plt.plot(boat, array(nord_pool_cost_be)/1000, marker='.', color='teal')
plt.plot(boat, array(LFM_cost_01_be)/1000, marker='.', color='indianred')
...
plt.plot(boat, array(nord_pool_revenue_be)/1000, marker='.', color='teal')
plt.plot(boat, array(LFM_total_revenue_01_be)/1000, marker='.', color='indianred')
plt.plot(boat, array(FCR_D_up_revenue_01_be)/1000, color='lightsteelblue', marker='.')
plt.plot(boat, array(FCR_D_down_revenue_01_be)/1000, color='cornflowerblue', marker='.')
plt.plot(boat, array(total_revenue_be)/1000, color='black', marker='.')
...
#ax1.plot(boat, LFM_grid_usage_01_be, color='black', marker='.', label='Electricity usage')
...
ax2 = ax1.twinx()
ax2.plot(boat, array(peak_cost_be)/1000, color='olivedrab', marker='.', linestyle='--', label='Optimized Grid Usage Cost')
#ax2.plot(boat, array(optimized_cost_nordpool_be)/1000, color='teal', marker='.', linestyle='--', label='Final Cost')
#ax2.plot(boat, array(optimized_cost_LFM_01_be)/1000, color='indianred', marker='.', linestyle='--', label='Final Cost')
#ax2.plot(boat, array(optimized_cost_FCR_D_LFM_01_be)/1000, color='black', marker='.', linestyle='--', label='Final Cost')
ax2.set_ylabel('Optimized Grid Usage Cost [kSEK]', color='dimgrey')
