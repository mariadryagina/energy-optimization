...
print(f"Self production: {round(self_production.sum()/1000,2)} MWh", 
      f"PV + Wind electricity sold: {round(np.nansum(sold_electricity_solar_hourly)/1000)} MWh")
...
plt.plot((grid_used_load_hourly + grid_used_battery_hourly), color="darkseagreen", alpha = 0.8)
